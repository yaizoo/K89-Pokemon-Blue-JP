# K89 Pokémon Blue JP Hen

Gen1Recomp版『Pokémon Blue』を日本語化するための非公式MODです。

> **重要:** このMODは **Pokémon Blue専用** です。Pokémon Redには対応していません。

このMODは、英語版のテキストを単純に翻訳したものではありません。

原作『ポケットモンスター 青』に収録されているオリジナルの日本語テキストや表現を基準に、Gen1Recomp上で当時の日本語版をできる限り再現することを目標に制作しています。

ゲーム内テキスト、ポケモン名、わざ名、マップ名、メニュー、名前入力画面、日本語フォントに対応しています。

また、濁点・半濁点の表示、UI、名前入力画面などについても個別に調整を行っています。
